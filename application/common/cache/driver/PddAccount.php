...
use app\common\model\pdd\PddAccount as PddAccountModel;
 ...
 * Time: 11:43
 */
class PddAccount extends Cache
{
    const cachePrefix = 'table';
    private $taskPrefix = 'task:pdd:';
    ...
    {
        $this->model(PddAccountModel::class);
        parent::__construct();
    }

    /**
     * Vova账号获取listing最后更新时间
     * @param int $accountId
     * @return int
     */
