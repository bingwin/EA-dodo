 ...
 * Time: 11:43
 */
class ZoodmallAccount extends Cache
{
    const cachePrefix = 'table';
    private $taskPrefix = 'task:zoodmall:';
    ...
    {
        $this->model(ZoodmallAccountModel::class);
        parent::__construct();
    }

    /**
     * zoodmall账号获取listing最后更新时间
     * @param int $accountId
     * @return int
     */
