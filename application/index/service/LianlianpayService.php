...
class LianlianpayService
{
    ...
    public function getLianlianpayList()
    {
        ...
        $order = 'lianlianpay_account.id';
        $sort = 'desc';
        $sortArr = [
            'ip_name' => 'lianlianpay_account.ip_name',
            'ip_address' => 'lianlianpay_account.ip_address',
            'channel_id' => 'lianlianpay_account.channel_id',
            'account_id' => 'lianlianpay_account.account_id',
            'site_code' => 'lianlianpay_account.site_code',
            'create_time' => 'lianlianpay_account.create_time',
        ];
        ...
        $field = 'lianlianpay_account.id,lianlianpay_account.ip_name,lianlianpay_account.ip_address,account.account_code,lianlianpay_account.site_code,lianlianpay_account.operator_id,
        lianlianpay_account.lianlian_account,lianlianpay_account.lianlian_name,lianlianpay_account.status,lianlianpay_account.create_id,lianlianpay_account.create_time';

        $count = $this->model
            ->join('account','lianlianpay_account.account_id=account.id','LEFT')
            ->where($where)
            ->count();
        $list = $this->model
            ->join('account','lianlianpay_account.account_id=account.id','LEFT')
    ...
    public function getWhere($params)
    {
        ...
        if (isset($params['account_code']) && ($params['account_code'] !== '')) {
            $where['account_code'] = ['like', '%'.$params['account_code'].'%'];
        }
