...
class AmazonHeelSalePriceResultQueuer extends SwooleQueueJob
{
    public function getName(): string
    {
        return 'amazon跟卖价格-获取跟卖上传结果';
    }
    ...
    public function execute()
    {
        ...
        if ($feedResult === false) {
            (new UniqueQueuer(AmazonHeelSalePriceResultQueuer::class))->push($id);
            return true;
        }
        ...
        if ($errorNum == 0){
            ...
            //更新跟卖日志状态
            $saleLogModel->update(['price_status' => 1], ['asin' => $saleLogData['asin'], 'type' => 1]);
