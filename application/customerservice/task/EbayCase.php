...
use app\customerservice\queue\EbayCaseQueue;


class EbayCase extends AbsTasker
{
    ...
    function push_queue()
    {
        ...
        $queuer = new CommonQueuer(EbayCaseQueue::class);
        ...
        foreach ($accountList as $k => $v) {
            ...
            $last_update = Cache::store('EbayAccount')->ebayLastUpdateTime($v['id'], 'case');
