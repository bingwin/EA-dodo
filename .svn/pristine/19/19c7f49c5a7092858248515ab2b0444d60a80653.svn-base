...
class ConsignPreferenceInfoResponses implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param string $dropoff_site_id èªéç«ç¹ID
     *
     * @return $this
     */
     ...
     * Sets pickup_address
     *
     * @param \Swagger\Client\Model\PickupAddressResponses $pickup_address ä¸é¨æ½æ¶å°å
     *
     * @return $this
     */
     ...
     * Sets pickup_time
     *
     * @param int $pickup_time æ½æ¶æ¶é´æ®µï¼æä¸¾ç±»åï¼å¯ç¨å¼ï¼TIME_14_16 - 14:00-16:00ï¼TIME_16_18 - 16:00-18:00
     *
     * @return $this
     */
