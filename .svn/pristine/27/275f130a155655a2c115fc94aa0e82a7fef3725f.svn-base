...
class PickupAddressRequest implements ModelInterface, ArrayAccess
{
     ...
     * Sets city
     *
     * @param string $city 市编码 <a target='_blank' href='/open/development-guide-detail?id=36'>请参考地址编码说明</a>
     *
     * @return $this
     */
     ...
     * Sets country_code
     *
     * @param string $country_code 国家或地区编码（暂不支持香港、台湾地区）<a target='_blank' href='/open/development-guide-detail?id=36'>请参考地址编码说明</a>
     *
     * @return $this
     */
     ...
     * Sets district
     *
     * @param string $district 区县编码 <a target='_blank' href='/open/development-guide-detail?id=36'>请参考地址编码说明</a>
     *
     * @return $this
     */
     ...
     * Sets province
     *
     * @param string $province 省编码 <a target='_blank' href='/open/development-guide-detail?id=36'>请参考地址编码说明</a>
     *
     * @return $this
     */
