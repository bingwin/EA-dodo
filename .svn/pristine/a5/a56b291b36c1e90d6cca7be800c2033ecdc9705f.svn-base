...
/**
 * ShipToAddressResponses Class Doc Comment
 *
 * @category Class
 * @description 收货地址
 * @package  Swagger\Client
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ShipToAddressResponses implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ShipToAddressResponses';
