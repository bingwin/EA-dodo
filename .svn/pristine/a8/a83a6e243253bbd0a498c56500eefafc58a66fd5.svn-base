...
use app\customerservice\queue\EbayReturnQueue;


class EbayReturn extends AbsTasker
{
    ...
    function push_queue()
    {
        ...
        $queuer = new CommonQueuer(EbayReturnQueue::class);
        ...
        foreach ($accountList as $k => $v) {
            ...
            $last_update = Cache::store('EbayAccount')->ebayLastUpdateTime($v['id'], 'return');
