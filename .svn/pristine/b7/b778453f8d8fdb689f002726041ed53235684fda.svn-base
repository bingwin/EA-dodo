...
class GetItemPackageIdResponsesData implements ModelInterface, ArrayAccess
{
     ...
     * Sets package_id
     *
     * @param string $package_id åè£¹ID,å¦æè¯¥è®¢åä½¿ç¨è¿éæ°åè´§ï¼ååªè¿åæè¿è·åçåè£¹ID
     *
     * @return $this
     */
     ...
     * Sets package_status
     *
     * @param string $package_status åè£¹å½åç¶æ <a target='_blank' href='/open/development-guide-detail?id=56'>è¯·åèåè£¹ç¶æè¯´æ</a>
     *
     * @return $this
     */
     ...
     *
     * @param string $tracking_number åè£¹è·è¸ªå·ï¼å¦æè¯¥è®¢åä½¿ç¨è¿éæ°åè´§ï¼ååªè¿åæè¿è·åçè·è¸ªå·
     *
     * @return $this
     */
