...
use app\customerservice\queue\EbayCancelQueue;


class EbayCancel extends AbsTasker
{
    ...
    function push_queue()
    {
        ...
        $queuer = new CommonQueuer(EbayCancelQueue::class);
        ...
        foreach ($accountList as $k => $v) {
            ...
            $last_update = Cache::store('EbayAccount')->ebayLastUpdateTime($v['id'], 'cancel');
