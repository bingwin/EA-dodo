...
/**
 * ConfirmPackageResponsesData Class Doc Comment
 *
 * @category Class
 * @description ç¡®è®¤ç»æ
 * @package  Swagger\Client
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ConfirmPackageResponsesData implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ConfirmPackageResponsesData';
