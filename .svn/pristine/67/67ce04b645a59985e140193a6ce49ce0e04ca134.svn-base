 ...
 *
 * @category Class
 * @description è´§ååè¡¨ï¼è³å°ä¸ä¸ª
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ItemRequest implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param string $order_line_item eBayäº¤æè¡ID
     *
     * @return $this
     */
     ...
     * Sets pay_pal_email
     *
     * @param string $pay_pal_email ä¹°å®¶PayPalçµé®å°å
     *
     * @return $this
     */
     ...
     *
     * @param string $pay_pal_message ä¹°å®¶PayPalçè¨
     *
     * @return $this
     */
     ...
     * Sets payment_date
     *
     * @param \DateTime $payment_date ä¹°å®¶ä»æ¬¾æ¥æ
     *
     * @return $this
     */
     ...
     * Sets posted_qty
     *
     * @param int $posted_qty å¯è´§æ°éï¼ä¸è½ä¸º0
     *
     * @return $this
     */
     ...
     *
     * @param float $received_amount å®éæ¶å°éé¢,å¿é¡»å¤§äº0.01
     *
     * @return $this
     */
     ...
     * Sets sold_date
     *
     * @param \DateTime $sold_date ååºæ¥æ
     *
     * @return $this
     */
     ...
     * Sets sold_price
     *
     * @param float $sold_price ååºæ»ä»·,å¿é¡»å¤§äº0.01
     *
     * @return $this
     */
